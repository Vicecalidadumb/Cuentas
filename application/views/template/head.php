...
<!--        <script src="<?php echo base_url('dist/js/jQuery-1.7.2-min.js'); ?>"></script>-->
        ...
        <link rel="stylesheet" href="<?php echo base_url('dist/js/jquery-ui-1.10.4.custom/development-bundle/themes/redmond/jquery-ui.css'); ?>">
        
        <script src="<?php echo base_url('dist/js/jquery-ui-1.10.4.custom/js/jquery-ui-1.10.4.custom.js'); ?>"></script>
